        ...
        <div class="p-8">
          ...
          <form @submit.prevent="submit" class="p-fluid">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-20">
              <div class="col-12 md:col-6">
                <div class="p-field">
                  ...
                  <Dialog v-model:visible="visible" modal header="PLEASE READ!"
                    ...
                    <template #header>
                      <h2 class="text-cyan-500 font-bold text-2xl">PLEASE READ!</h2>
                    </template>
                    <div class="modal-box max-h-max m-auto">
                      <h4 class="uppercase font-bold">To avoid application disapproval, Please follow the photo
                      ...
                      <div
                        ...
                        <div class="flex justify-center">
                          <img src="/images/female.jpg" alt="Photo Sample 1" class="w-64 h-[320px] object-cover">
                        </div>
                        <div class="h-[320px] border-l-2 border-dashed border-gray-300 hidden md:block"></div>
                        <div class="flex justify-center">
                          <img src="/images/male.jpeg" alt="Photo Sample 2" class="w-64 h-[320px] object-cover">
                        </div>
                      </div>
              ...
              <div class="col-12 md:col-6">
                <div class="p-field">
                  <label for="course_major" class="block mb-2">Please specify your course and major.</label>
                  ...
                  <div v-else>
                    <InputText v-model="form.course_major"
                               ...
                               placeholder="e.g., Computer Science - Software Engineering" class="w-full"/>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-20">
              <div class="col-12">
                <div class="p-field-checkbox flex items-center mb-4">
                  <Checkbox id="has_previous_company" v-model="form.has_previous_company" :binary="true" class="mr-2"/>
            ...
            <div v-if="form.has_previous_company" class="grid grid-cols-1 md:grid-cols-2 gap-x-20">
              ...
              <div class="col-12 md:col-6">
                <div class="p-field">
                  <label for="years_of_service" class="block mb-2">Years of Service (Previous Company)</label>
            ...
            <!-- Success modal -->
            <Dialog v-model:visible="successDialogVisible" modal :closable="false" class="p-fluid w-[36rem]">
              <template #header>
              ...
              <div class="text-center">
                ...
                <p class="text-sm text-gray-600 mb-2">Thank you for applying. We will review your application and get
                  back to you soon.</p>
                <p class="text-sm text-blue-600 font-semibold mt-4">Just a friendly reminder: There's no need to submit
                  multiple applications. We've got your information and will give it our full attention!</p>
              </div>
              <template #footer>
                <div class="flex justify-content-center">
                  <Button label="Close" icon="pi pi-times" @click="closeSuccessDialog" class="p-button-text"/>
                </div>
              </template>
            </Dialog>
          </form>
