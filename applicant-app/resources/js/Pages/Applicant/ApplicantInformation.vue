...
<template>
    ...
    <AuthenticatedLayout>
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 shadow-lg rounded-lg p-8 max-w-4xl mx-auto mt-8">
            <h1 class="text-3xl font-bold mb-8 text-indigo-800 border-b-2 border-indigo-200 pb-2">Applicant
                Information</h1>
                ...
                <div class="space-y-6">
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div class="flex items-center mb-4">
                            <img :src="getImageUrl(applicant.image_path)" alt="Applicant Photo" class="w-32 h-32 object-cover rounded-full mr-4">
                            <div>
                                <p class="font-medium text-lg text-indigo-600">{{ applicant.first_name }} {{ applicant.middle_initial }} {{ applicant.last_name }} {{ applicant.suffix }}</p>
